...
function jump(){
    ...
    switch(selection){
        case "地理":
            window.location.href = "quiz.html?type=地理&nof="+q;
            break;

        case "歴史":
            window.location.href = "quiz.html?type=歴史&nof="+q;
            break;

        case "理科":
            window.location.href = "quiz.html?type=理科&nof="+q;
            break;
        default:
            window.location.href = "quiz.html?nof="+q;
    }
}
function select(tp){
    selection = tp;
